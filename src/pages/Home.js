...
const Home = () => {
  return (
    <div className="pages-home wrapper">
      <p>
        I'm a full stack web developer working at <a href="https://www.zensurance.com/" rel="noopener noreferrer" target="_blank">Zensurance</a> in Toronto, using React/Redux, NodeJS, and Vanilla JS.
      </p>
      <p>
